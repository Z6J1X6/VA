...
Next, you will use the code chunk below to install and launch ,  [**ggpubr**](https://rpkgs.datanovia.com/ggpubr/) and **tidyverse** in RStudio.
```{r}
